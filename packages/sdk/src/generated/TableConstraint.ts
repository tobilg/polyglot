...
export type TableConstraint =
  ...
  | { Projection: { name: Identifier; expression: Expression } }
  | {
      Like: {
        source: TableRef;
        /**
         ...
         */
        options: Array<[LikeOptionAction, string]>;
      };
    }
  | { PeriodForSystemTime: { start_col: Identifier; end_col: Identifier } }
  | {
      Exclude: {
        name: Identifier | null;
        /**
         ...
         */
        using_index_tablespace: string | null;
        modifiers: ConstraintModifiers;
      };
    }
  | { Tags: Tags }
