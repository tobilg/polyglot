...
pub use normalize::{normalize, normalized, normalization_distance, NormalizeError, DEFAULT_MAX_DISTANCE};
/// Identifier normalization, case sensitivity detection, and strategy types
pub use normalize_identifiers::{
    normalize_identifiers, normalize_identifier, get_normalization_strategy,
    is_case_sensitive, NormalizationStrategy
};
/// JOIN optimization, reordering, normalization, and reorderability checks
pub use optimize_joins::{optimize_joins, reorder_joins, normalize_joins, is_reorderable};
...
pub use pushdown_projections::{pushdown_projections, default_selection};
/// Column qualification, validation, output handling, and identifier quoting
pub use qualify_columns::{
    qualify_columns, validate_qualify_columns, qualify_outputs, quote_identifiers,
    QualifyColumnsOptions, QualifyColumnsError
};
...
pub use simplify::{simplify, always_true, always_false, is_false, is_null, is_zero, Simplifier};
/// Subquery merging, unnesting, and correlation analysis
pub use subquery::{merge_subqueries, unnest_subqueries, is_mergeable, is_correlated};
...
pub use optimizer::{optimize, optimize_with_rules, quick_optimize, OptimizerConfig, OptimizationRule, DEFAULT_RULES};
