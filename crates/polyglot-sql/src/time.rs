...
/// - Region-based names
pub static TIMEZONES: std::sync::LazyLock<HashSet<&'static str>> =
...
mod tests {
    ...
    fn test_subsecond_precision_with_timezone() {
        assert_eq!(
            subsecond_precision("2023-01-01 12:13:14.123+00:00"),
            3
        );
        assert_eq!(
            subsecond_precision("2023-01-01T12:13:14.123456Z"),
            6
        );
    }
